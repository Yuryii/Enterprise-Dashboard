...
using static EnterpriseDashboard.Core.SeedWorks.Constants.Permissions;
...
using EnterpriseDashboard.Core.Models.System;
using Microsoft.EntityFrameworkCore;
using EnterpriseDashboard.Api.Extensions;
using EnterpriseDashboard.Core.Repositories;
using EnterpriseDashboard.Core.SeedWorks;

namespace EnterpriseDashboard.Api.Controllers.AdminApi
{
