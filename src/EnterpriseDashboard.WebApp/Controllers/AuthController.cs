...
using EnterpriseDashboard.Core.Events.LoginSuccessed;
using EnterpriseDashboard.Core.Events.RegisterSuccessed;
using EnterpriseDashboard.Core.SeedWorks.Constants;
using EnterpriseDashboard.WebApp.Extensions;
using EnterpriseDashboard.WebApp.Models;
using EnterpriseDashboard.WebApp.Services;

namespace EnterpriseDashboard.WebApp.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            //    Content = $"Click <a href='{callbackUrl}'>here</a> to reset your password."
            //};
