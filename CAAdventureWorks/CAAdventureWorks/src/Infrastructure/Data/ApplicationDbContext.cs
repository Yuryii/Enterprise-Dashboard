...
public partial class ApplicationDbContext : DbContext, IApplicationDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vendor>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate).HasDefaultValueSql("(getdate())", "DF_Vendor_ModifiedDate");
        ...
        modelBuilder.Entity<WorkOrder>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate).HasDefaultValueSql("(getdate())", "DF_WorkOrder_ModifiedDate");
        ...
        modelBuilder.Entity<WorkOrderRouting>(entity =>
        {
            ...
            entity.Property(e => e.ModifiedDate).HasDefaultValueSql("(getdate())", "DF_WorkOrderRouting_ModifiedDate");
