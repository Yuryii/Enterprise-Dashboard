...
export class FinanceComponent implements OnInit {
  ...
  readonly availableCharts: ChartDef[] = [
    ...
    { id: 'expense-trend', label: 'Xu hướng chi phí' },
    { id: 'profit-trend', label: 'Xu hướng lợi nhuận' },
    { id: 'cash-flow', label: 'Dòng tiền (Cash Flow)' },
    { id: 'tax-by-region', label: 'Thuế theo vùng' },
    { id: 'revenue-by-currency', label: 'Doanh thu theo tiền tệ' },
  ...
  private getDefaultLayout(): GridsterItemConfig[] {
    return [
      { id: 'revenue-trend', cols: 6, rows: 6, x: 0, y: 0 },
      { id: 'expense-trend', cols: 6, rows: 6, x: 6, y: 0 },
      { id: 'profit-trend', cols: 8, rows: 6, x: 0, y: 6 },
      { id: 'revenue-by-currency', cols: 4, rows: 6, x: 8, y: 6 },
      { id: 'cash-flow', cols: 8, rows: 6, x: 0, y: 12 },
      { id: 'payment-methods', cols: 4, rows: 6, x: 8, y: 12 },
      { id: 'tax-by-region', cols: 12, rows: 5, x: 0, y: 18 }
    ];
  }
